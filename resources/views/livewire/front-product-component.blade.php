<div class="max-w-sm rounded-lg overflow-hidden shadow-lg bg-white" wire:key="{{ $product->id }}">
    ...
    <div class="h-56 overflow-hidden relative">
        ...
        @else
            <img
                ...
                src="{{ asset('assets/no-image.webp') }}"
                alt="{{ $product->name }}"
                loading="lazy"
            />
        @endif
    ...
    <div class="p-6">
        ...
        <button
            ...
            class="w-full py-2 px-4 rounded-lg transition-colors duration-200 {{
                $added ? 'bg-red-700 hover:bg-red-800' : 'bg-green-700 hover:bg-green-800'
            }} text-white"
        >
