            ...
            <div class="flex flex-col sm:flex-row justify-between items-center py-2">
                ...
                <div class="flex flex-wrap justify-center gap-4">
                    ...
                    <div class="flex items-center gap-x-2">
                        ...
                        <a href="https://wa.me/{{ $setting->whatsapp }}" class="text-sm hover:text-green-200 transition-colors">
                            {{ $setting->whatsapp }}
                        </a>
                    </div>
                    <div class="flex items-center gap-x-2">
                        ...
                        <a href="mailto:{{ $setting->email_one }}" class="text-sm hover:text-green-200 transition-colors">
                            {{ $setting->email_one }}
                        </a>
                    </div>
                    <div class="flex items-center gap-x-2">
                ...
                <div class="mt-2 sm:mt-0">
                    <a href="/admin/login" class="text-sm hover:text-green-200 transition-colors flex items-center gap-x-2">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
        ...
        <div class="container mx-auto px-4">
                    ...
                    <div class="flex space-x-8">
                        <a href="{{route('welcome')}}"
                           class="text-lg transition-colors relative group {{ request()->routeIs('welcome') ? 'text-green-700 font-semibold' : 'hover:text-green-700' }}">
                            Home
                            <span class="absolute bottom-0 left-0 w-full h-0.5 bg-green-700 transform scale-x-0 group-hover:scale-x-100 transition-transform origin-left {{ request()->routeIs('landing') ? 'scale-x-100' : '' }}"></span>
                        </a>
                        <a href="{{ route('shop') }}"
                           class="text-lg transition-colors relative group {{ request()->routeIs('shop') ? 'text-green-700 font-semibold' : 'hover:text-green-700' }}">
                            Shop
                            <span class="absolute bottom-0 left-0 w-full h-0.5 bg-green-700 transform scale-x-0 group-hover:scale-x-100 transition-transform origin-left {{ request()->routeIs('shop') ? 'scale-x-100' : '' }}"></span>
                        </a>
                        ...
                        <a href="{{ route('contact') }}"
                           class="text-lg transition-colors relative group {{ request()->routeIs('contact') ? 'text-green-700 font-semibold' : 'hover:text-green-700' }}">
                            Contact us
                            <span class="absolute bottom-0 left-0 w-full h-0.5 bg-green-700 transform scale-x-0 group-hover:scale-x-100 transition-transform origin-left {{ request()->routeIs('contact') ? 'scale-x-100' : '' }}"></span>
                        </a>
            ...
            <div class="md:hidden">
                <div class="flex justify-between items-center">
                    <!-- Logo -->
                    <a href="{{ route('welcome') }}">
                        <img src="{{ asset('assets/Logo.png') }}" alt="{{ config('app.name') }}" class="h-10 w-auto">
                    </a>
